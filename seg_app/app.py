...
class AISpleenSegApp(Application):
    ...
    def compose(self):
        ...
        dicom_rgb_mask_writer = DICOMRGBMaskWriterOperator(self, name="dicom_rgb_mask_writer",
                                                           segment_descriptions=segment_descriptions,
                                                           custom_tags=custom_tags,
                                                           output_folder=app_output_path,
                                                           ) 
        ...
        #stl_conversion_op = STLConversionOperator( self, output_file=app_output_path.joinpath("stl/spleen.stl"), name="stl_conversion_op")
        #self.add_flow(bundle_spleen_seg_op, stl_conversion_op, {("pred", "image")})
        
        self.add_flow(series_selector_op, dicom_rgb_mask_writer, {("study_selected_series_list", "study_selected_series_list")})
       
        
        self.add_flow(bundle_spleen_seg_op, dicom_rgb_mask_writer, {("pred", "seg_image")})
